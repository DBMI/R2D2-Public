...
library(SqlRender)
query13SqlTemplate <- render(SqlRender::readSql("~/git/R2D2-Queries/Question_0013/sql/SqlRender_input.sql"))
...
Database: SQL Server
This script is modelled  on script for Question_0012 by Paulina Paul, 6/17/2020
...
*************************************************************************************************************/
	...
	from @vocab_schema.concept 
	where concept_id in (2722265,3015182,3199253,4281085,37034753,37397924,3019897,40451480,40765008,40772243,3139442,3402075,40774640,3002888,37041261,42536363,3437270,37039984,37043842,40773752,40789356,45441808,2722266,3002385,3049383);
