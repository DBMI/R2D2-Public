...
use [IRB_HS-14-00393_pSCANNER];

/*********************** Initialize variables *****************/
declare @sitename varchar(20) = 'Site11';
		...
		-- insert into #PatientBloodtypeTemp all recorded blood types from Measurment and Condition tables
		 ...
		 , Report_name_sort
		  ...
		  (
			...
			left outer join measurement m on m.person_id = p.person_id 
			...
			from 
			(select distinct person_id from #covid_hsp hsp) p
			join observation o on o.person_id = p.person_id 
