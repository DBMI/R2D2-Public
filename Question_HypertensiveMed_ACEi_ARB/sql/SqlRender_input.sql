...
library(SqlRender)
query14SqlTemplate <- render(SqlRender::readSql("~/git/R2D2-Queries/Question_0014/sql/SqlRender_input.sql"))
...
select c.*
from @vocab_schema.concept c, @vocab_schema.concept_relationship cr
...
from @vocab_schema.concept c, @vocab_schema.concept_ancestor ca
...
from #covid_hsp cp 
join @cdm_schema.condition_occurrence co on cp.person_id = co.person_id 
