...
Question in Text: COVID19 patient identification & Hospitalization using R2D2 conceptset and hospitalization definition
Database: SQL Server
...
declare @minAllowedCellCount int = 11;
...
if object_id('tempdb.dbo.#deceased_concepts') is  not null drop table #deceased_concepts
...
select a.visit_occurrence_id, a.person_id, a.visit_concept_id, a.visit_start_datetime, a.visit_end_datetime
		, a.discharge_to_concept_id, left(a.discharge_to_source_value, 256) discharge_to_source_value, a.AgeAtVisit,  a.cohort_start_date, a.days_bet_COVID_tst_hosp
		, d.death_datetime 	
